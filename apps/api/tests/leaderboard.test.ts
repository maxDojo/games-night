...
describe('leaderboard route', () => {
  ...
  it('returns standings summed across rounds, ranked, including zero-score teams', async () => {
    ...
    expect(body.entries[2]).toMatchObject({ teamId: 't3', totalPoints: 0, rank: 3, roundsPlayed: 0 });
  });

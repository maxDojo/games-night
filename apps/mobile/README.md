...
- API-backed player join-code lookup, capacity-aware team selection, anonymous player check-in, player-safe party status, Trivia answer submission, and Socket.IO party-room join.
